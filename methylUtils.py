...
def blastAlign(seq_filePath, ref_file, align_name, blastExecPath, n_thread,
               reward=2, penalty=-3, gapopen=5, gapextend=2, word_size=11, window_size=60, outfmt=5):
    os.mkdir("blastDB")
    os.chdir("blastDB")
    ...
    blastn_cline = NcbiblastnCommandline(cmd=blastExecPath + 'blastn', query=seq_filePath,
                                         ...
                                         word_size=11, window_size=60, outfmt=5, num_threads=n_thread,
                                         out=align_name + ".xml")
...
def extract_profiles(refFile, primersPath, sample, bisu_thresh, bisuBaseThresh, cgAmbThresh, alignPropThresh,
                     blastExecPath,
                     nThreadBlast, reward, penalty, gapopen, gapextend, word_size, window_size):
    wdir = os.getcwd()
